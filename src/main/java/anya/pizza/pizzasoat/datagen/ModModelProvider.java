...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.registerArmor(ModItems.PINKU_HELMET, Identifier.of(PizzasOAT.MOD_ID, "pinku"), ModArmorMaterials.PINKU, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.PINKU_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "pinku"), ModArmorMaterials.PINKU, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.PINKU_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "pinku"), ModArmorMaterials.PINKU, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.PINKU_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "pinku"), ModArmorMaterials.PINKU, EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModItems.RAINBOW_PYRITE_HELMET, Identifier.of(PizzasOAT.MOD_ID, "rainbow"), ModArmorMaterials.RAINBOW, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.RAINBOW_PYRITE_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "rainbow"), ModArmorMaterials.RAINBOW, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.RAINBOW_PYRITE_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "rainbow"), ModArmorMaterials.RAINBOW, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.RAINBOW_PYRITE_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "rainbow"), ModArmorMaterials.RAINBOW, EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModItems.TUNGSTEN_HELMET, Identifier.of(PizzasOAT.MOD_ID, "tungsten"), ModArmorMaterials.TUNGSTEN, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.TUNGSTEN_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "tungsten"), ModArmorMaterials.TUNGSTEN, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.TUNGSTEN_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "tungsten"), ModArmorMaterials.TUNGSTEN, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.TUNGSTEN_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "tungsten"), ModArmorMaterials.TUNGSTEN, EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModItems.ALUMINUM_HELMET, Identifier.of(PizzasOAT.MOD_ID, "aluminum"), ModArmorMaterials.ALUMINUM, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.ALUMINUM_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "aluminum"), ModArmorMaterials.ALUMINUM, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.ALUMINUM_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "aluminum"), ModArmorMaterials.ALUMINUM, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.ALUMINUM_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "aluminum"), ModArmorMaterials.ALUMINUM, EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModItems.SAPPHIRE_HELMET, Identifier.of(PizzasOAT.MOD_ID, "sapphire"), ModArmorMaterials.SAPPHIRE, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.SAPPHIRE_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "sapphire"), ModArmorMaterials.SAPPHIRE, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.SAPPHIRE_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "sapphire"), ModArmorMaterials.SAPPHIRE, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.SAPPHIRE_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "sapphire"), ModArmorMaterials.SAPPHIRE, EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModItems.NEPHRITE_HELMET, Identifier.of(PizzasOAT.MOD_ID, "nephrite"), ModArmorMaterials.NEPHRITE, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.NEPHRITE_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "nephrite"), ModArmorMaterials.NEPHRITE, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.NEPHRITE_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "nephrite"), ModArmorMaterials.NEPHRITE, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.NEPHRITE_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "nephrite"), ModArmorMaterials.NEPHRITE, EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModItems.JADEITE_HELMET, Identifier.of(PizzasOAT.MOD_ID, "jadeite"), ModArmorMaterials.JADEITE, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.JADEITE_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "jadeite"), ModArmorMaterials.JADEITE, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.JADEITE_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "jadeite"), ModArmorMaterials.JADEITE, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.JADEITE_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "jadeite"), ModArmorMaterials.JADEITE, EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModItems.PLATINUM_HELMET, Identifier.of(PizzasOAT.MOD_ID, "platinum"), ModArmorMaterials.PLATINUM, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.PLATINUM_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "platinum"), ModArmorMaterials.PLATINUM, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.PLATINUM_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "platinum"), ModArmorMaterials.PLATINUM, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.PLATINUM_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "platinum"), ModArmorMaterials.PLATINUM, EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModItems.STEEL_HELMET, Identifier.of(PizzasOAT.MOD_ID, "steel"), ModArmorMaterials.STEEL, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.STEEL_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "steel"), ModArmorMaterials.STEEL, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.STEEL_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "steel"), ModArmorMaterials.STEEL, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.STEEL_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "steel"), ModArmorMaterials.STEEL, EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModItems.CAST_STEEL_HELMET, Identifier.of(PizzasOAT.MOD_ID, "cast_steel"), ModArmorMaterials.CAST_STEEL, EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModItems.CAST_STEEL_CHESTPLATE, Identifier.of(PizzasOAT.MOD_ID, "cast_steel"), ModArmorMaterials.CAST_STEEL, EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModItems.CAST_STEEL_LEGGINGS, Identifier.of(PizzasOAT.MOD_ID, "cast_steel"), ModArmorMaterials.CAST_STEEL, EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModItems.CAST_STEEL_BOOTS, Identifier.of(PizzasOAT.MOD_ID, "cast_steel"), ModArmorMaterials.CAST_STEEL, EquipmentSlot.FEET);
