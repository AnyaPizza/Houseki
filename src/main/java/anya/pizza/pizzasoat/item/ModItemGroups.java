...
public class ModItemGroups {
    public static final ItemGroup PIZZAS_ITEMS_GROUP = Registry.register(Registries.ITEM_GROUP,
            Identifier.of(PizzasOAT.MOD_ID, "pizzas_items"),
            FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.PINKU))
                    .displayName(Text.translatable("itemgroup.pizzasoat.pizzasitems"))
    ...
    public static final ItemGroup PIZZAS_BLOCKS_GROUP = Registry.register(Registries.ITEM_GROUP,
            Identifier.of(PizzasOAT.MOD_ID, "pizzas_blocks"),
            FabricItemGroup.builder().icon(() -> new ItemStack(ModBlocks.BLOCK_OF_PINKU))
                    .displayName(Text.translatable("itemgroup.pizzasoat.pizzasblocks"))
                    .entries((displayContext, entries) -> {
    ...
    public static void registerItemGroups() {
        PizzasOAT.LOGGER.info("Registering ItemGroups for " + PizzasOAT.MOD_ID);
    }
}
