...
public class ModItems {
    ...
    public static final Item PINKU_PICKAXE = registerItem("pinku_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.PINKU, 8, 1.5f)));
    ...
    public static final Item PINKU_SWORD = registerItem("pinku_sword",
            setting -> new Item(setting.sword(ModToolMaterials.PINKU, 10, 1.9f)));
    ...
    public static final Item RAINBOW_PYRITE_PICKAXE = registerItem("rainbow_pyrite_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.RAINBOW_PYRITE, 0, 1.3f)));
    ...
    public static final Item RAINBOW_PYRITE_SWORD = registerItem("rainbow_pyrite_sword",
            setting -> new Item(setting.sword(ModToolMaterials.RAINBOW_PYRITE, 2, 1.3f)));
    ...
    public static final Item TUNGSTEN_PICKAXE = registerItem("tungsten_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.TUNGSTEN, 1, 1.4f).fireproof()));
    ...
    public static final Item SIMPLE_TUNGSTEN_DRILL = registerItem("simple_tungsten_drill",
            setting -> new Item(setting.pickaxe(ModToolMaterials.TUNGSTEN_DRILL, 2, 1.9f).fireproof()));
    ...
    public static final Item ALUMINUM_PICKAXE = registerItem("aluminum_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.ALUMINUM, 0, 1.3f)));
    ...
    public static final Item ALUMINUM_SWORD = registerItem("aluminum_sword",
            setting -> new Item(setting.sword(ModToolMaterials.ALUMINUM, 2, 1.3f)));
    ...
    public static final Item SAPPHIRE_PICKAXE = registerItem("sapphire_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.SAPPHIRE, 1, 2.4f)));
    ...
    public static final Item SAPPHIRE_SWORD = registerItem("sapphire_sword",
            setting -> new Item(setting.sword(ModToolMaterials.SAPPHIRE, 3, 2.7f)));
    ...
    public static final Item NEPHRITE_PICKAXE = registerItem("nephrite_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.NEPHRITE, 0, 1.3f)));
    ...
    public static final Item NEPHRITE_SWORD = registerItem("nephrite_sword",
            setting -> new Item(setting.sword(ModToolMaterials.NEPHRITE, 2, 1.5f)));
    ...
    public static final Item JADEITE_PICKAXE = registerItem("jadeite_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.JADEITE, 0.5f, 1.3f)));
    ...
    public static final Item JADEITE_SWORD = registerItem("jadeite_sword",
            setting -> new Item(setting.sword(ModToolMaterials.JADEITE, 2, 1.5f)));
    ...
    public static final Item PLATINUM_PICKAXE = registerItem("platinum_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.PLATINUM, 1, 1.4f)));
    ...
    public static final Item PLATINUM_SWORD = registerItem("platinum_sword",
            setting -> new Item(setting.sword(ModToolMaterials.PLATINUM, 2, 1.7f)));
    ...
    public static final Item STEEL_PICKAXE = registerItem("steel_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.STEEL, 0.5f, 1.0f)));
    ...
    public static final Item STEEL_SWORD = registerItem("steel_sword",
            setting -> new Item(setting.sword(ModToolMaterials.STEEL, 2, 1.0f)));
    ...
    public static final Item CAST_STEEL_PICKAXE = registerItem("cast_steel_pickaxe",
            setting -> new Item(setting.pickaxe(ModToolMaterials.CAST_STEEL, 1, 1.0f)));
    ...
    public static final Item CAST_STEEL_SWORD = registerItem("cast_steel_sword",
            setting -> new Item(setting.sword(ModToolMaterials.CAST_STEEL, 3, 1.0f)));
    ...
    public static final Item SIMPLE_DIAMOND_DRILL = registerItem("simple_diamond_drill",
            setting -> new Item(setting.pickaxe(ModToolMaterials.DIAMOND_DRILL, 1, -2.8f).fireproof()));
    ...
    public static final Item PINKU_HELMET = registerItem("pinku_helmet",
            setting -> new Item(setting.armor(ModArmorMaterials.PINKU_MATERIAL, EquipmentType.HELMET)));
    public static final Item PINKU_CHESTPLATE = registerItem("pinku_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.PINKU_MATERIAL, EquipmentType.CHESTPLATE)));
    public static final Item PINKU_LEGGINGS = registerItem("pinku_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.PINKU_MATERIAL, EquipmentType.LEGGINGS)));
    public static final Item PINKU_BOOTS = registerItem("pinku_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.PINKU_MATERIAL, EquipmentType.BOOTS)));

    public static final Item RAINBOW_PYRITE_HELMET = registerItem("rainbow_pyrite_helmet",
            setting -> new ModArmorItem(setting.armor(ModArmorMaterials.RAINBOW_MATERIAL, EquipmentType.HELMET)));
    public static final Item RAINBOW_PYRITE_CHESTPLATE = registerItem("rainbow_pyrite_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.RAINBOW_MATERIAL, EquipmentType.CHESTPLATE)));
    public static final Item RAINBOW_PYRITE_LEGGINGS = registerItem("rainbow_pyrite_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.RAINBOW_MATERIAL, EquipmentType.LEGGINGS)));
    public static final Item RAINBOW_PYRITE_BOOTS = registerItem("rainbow_pyrite_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.RAINBOW_MATERIAL, EquipmentType.BOOTS)));

    public static final Item TUNGSTEN_HELMET = registerItem("tungsten_helmet",
            setting -> new ModArmorItem(setting.armor(ModArmorMaterials.TUNGSTEN_MATERIAL, EquipmentType.HELMET).fireproof()));
    public static final Item TUNGSTEN_CHESTPLATE = registerItem("tungsten_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.TUNGSTEN_MATERIAL, EquipmentType.CHESTPLATE).fireproof()));
    public static final Item TUNGSTEN_LEGGINGS = registerItem("tungsten_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.TUNGSTEN_MATERIAL, EquipmentType.LEGGINGS).fireproof()));
    public static final Item TUNGSTEN_BOOTS = registerItem("tungsten_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.TUNGSTEN_MATERIAL, EquipmentType.BOOTS).fireproof()));

    public static final Item ALUMINUM_HELMET = registerItem("aluminum_helmet",
            setting -> new ModArmorItem(setting.armor(ModArmorMaterials.ALUMINUM_MATERIAL, EquipmentType.HELMET)));
    public static final Item ALUMINUM_CHESTPLATE = registerItem("aluminum_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.ALUMINUM_MATERIAL, EquipmentType.CHESTPLATE)));
    public static final Item ALUMINUM_LEGGINGS = registerItem("aluminum_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.ALUMINUM_MATERIAL, EquipmentType.LEGGINGS)));
    public static final Item ALUMINUM_BOOTS = registerItem("aluminum_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.ALUMINUM_MATERIAL, EquipmentType.BOOTS)));

    public static final Item SAPPHIRE_HELMET = registerItem("sapphire_helmet",
            setting -> new ModArmorItem(setting.armor(ModArmorMaterials.SAPPHIRE_MATERIAL, EquipmentType.HELMET)));
    public static final Item SAPPHIRE_CHESTPLATE = registerItem("sapphire_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.SAPPHIRE_MATERIAL, EquipmentType.CHESTPLATE)));
    public static final Item SAPPHIRE_LEGGINGS = registerItem("sapphire_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.SAPPHIRE_MATERIAL, EquipmentType.LEGGINGS)));
    public static final Item SAPPHIRE_BOOTS = registerItem("sapphire_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.SAPPHIRE_MATERIAL, EquipmentType.BOOTS)));

    public static final Item NEPHRITE_HELMET = registerItem("nephrite_helmet",
            setting -> new ModArmorItem(setting.armor(ModArmorMaterials.NEPHRITE_MATERIAL, EquipmentType.HELMET)));
    public static final Item NEPHRITE_CHESTPLATE = registerItem("nephrite_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.NEPHRITE_MATERIAL, EquipmentType.CHESTPLATE)));
    public static final Item NEPHRITE_LEGGINGS = registerItem("nephrite_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.NEPHRITE_MATERIAL, EquipmentType.LEGGINGS)));
    public static final Item NEPHRITE_BOOTS = registerItem("nephrite_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.NEPHRITE_MATERIAL, EquipmentType.BOOTS)));

    public static final Item JADEITE_HELMET = registerItem("jadeite_helmet",
            setting -> new ModArmorItem(setting.armor(ModArmorMaterials.JADEITE_MATERIAL, EquipmentType.HELMET)));
    public static final Item JADEITE_CHESTPLATE = registerItem("jadeite_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.JADEITE_MATERIAL, EquipmentType.CHESTPLATE)));
    public static final Item JADEITE_LEGGINGS = registerItem("jadeite_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.JADEITE_MATERIAL, EquipmentType.LEGGINGS)));
    public static final Item JADEITE_BOOTS = registerItem("jadeite_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.JADEITE_MATERIAL, EquipmentType.BOOTS)));

    public static final Item PLATINUM_HELMET = registerItem("platinum_helmet",
            setting -> new ModArmorItem(setting.armor(ModArmorMaterials.PLATINUM_MATERIAL, EquipmentType.HELMET)));
    public static final Item PLATINUM_CHESTPLATE = registerItem("platinum_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.PLATINUM_MATERIAL, EquipmentType.CHESTPLATE)));
    public static final Item PLATINUM_LEGGINGS = registerItem("platinum_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.PLATINUM_MATERIAL, EquipmentType.LEGGINGS)));
    public static final Item PLATINUM_BOOTS = registerItem("platinum_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.PLATINUM_MATERIAL, EquipmentType.BOOTS)));

    public static final Item STEEL_HELMET = registerItem("steel_helmet",
            setting -> new Item(setting.armor(ModArmorMaterials.STEEL_MATERIAL, EquipmentType.HELMET)));
    public static final Item STEEL_CHESTPLATE = registerItem("steel_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.STEEL_MATERIAL, EquipmentType.CHESTPLATE)));
    public static final Item STEEL_LEGGINGS = registerItem("steel_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.STEEL_MATERIAL, EquipmentType.LEGGINGS)));
    public static final Item STEEL_BOOTS = registerItem("steel_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.STEEL_MATERIAL, EquipmentType.BOOTS)));

    public static final Item CAST_STEEL_HELMET = registerItem("cast_steel_helmet",
            setting -> new ModArmorItem(setting.armor(ModArmorMaterials.CAST_STEEL_MATERIAL, EquipmentType.HELMET)));
    public static final Item CAST_STEEL_CHESTPLATE = registerItem("cast_steel_chestplate",
            setting -> new Item(setting.armor(ModArmorMaterials.CAST_STEEL_MATERIAL, EquipmentType.CHESTPLATE)));
    public static final Item CAST_STEEL_LEGGINGS = registerItem("cast_steel_leggings",
            setting -> new Item(setting.armor(ModArmorMaterials.CAST_STEEL_MATERIAL, EquipmentType.LEGGINGS)));
    public static final Item CAST_STEEL_BOOTS = registerItem("cast_steel_boots",
            setting -> new Item(setting.armor(ModArmorMaterials.CAST_STEEL_MATERIAL, EquipmentType.BOOTS)));

    //Horse Armor
    public static final Item PINKU_HORSE_ARMOR = registerItem("pinku_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.PINKU_MATERIAL).maxCount(1)));
    public static final Item RAINBOW_PYRITE_HORSE_ARMOR = registerItem("rainbow_pyrite_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.RAINBOW_MATERIAL).maxCount(1)));
    public static final Item TUNGSTEN_HORSE_ARMOR = registerItem("tungsten_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.TUNGSTEN_MATERIAL).maxCount(1).fireproof()));
    public static final Item ALUMINUM_HORSE_ARMOR = registerItem("aluminum_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.ALUMINUM_MATERIAL).maxCount(1)));
    public static final Item SAPPHIRE_HORSE_ARMOR = registerItem("sapphire_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.SAPPHIRE_MATERIAL).maxCount(1)));
    public static final Item PLATINUM_HORSE_ARMOR = registerItem("platinum_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.PLATINUM_MATERIAL).maxCount(1)));
    public static final Item STEEL_HORSE_ARMOR = registerItem("steel_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.STEEL_MATERIAL).maxCount(1)));
    public static final Item CAST_STEEL_HORSE_ARMOR = registerItem("cast_steel_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.CAST_STEEL_MATERIAL).maxCount(1)));
    public static final Item NEPHRITE_HORSE_ARMOR = registerItem("nephrite_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.NEPHRITE_MATERIAL).maxCount(1)));
    public static final Item JADEITE_HORSE_ARMOR = registerItem("jadeite_horse_armor",
            setting -> new Item(setting.horseArmor(ModArmorMaterials.JADEITE_MATERIAL).maxCount(1)));


    private static Item registerItem(String name, Function<Item.Settings, Item> function) {
        return Registry.register(Registries.ITEM, Identifier.of(PizzasOAT.MOD_ID, name),
                function.apply(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(PizzasOAT.MOD_ID, name)))));
    }
