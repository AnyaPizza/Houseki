...
public class ModArmorMaterials {
    ...
    public static final RegistryKey<EquipmentAsset> NEPHRITE_KEY = RegistryKey.of(REGISTRY_KEY, Identifier.of(PizzasOAT.MOD_ID, "nephrite"));
    public static final RegistryKey<EquipmentAsset> JADEITE_KEY = RegistryKey.of(REGISTRY_KEY, Identifier.of(PizzasOAT.MOD_ID, "jadeite"));
    public static final RegistryKey<EquipmentAsset> PLATINUM_KEY =RegistryKey.of(REGISTRY_KEY, Identifier.of(PizzasOAT.MOD_ID, "platinum"));
    public static final RegistryKey<EquipmentAsset> STEEL_KEY = RegistryKey.of(REGISTRY_KEY, Identifier.of(PizzasOAT.MOD_ID, "steel"));
    public static final RegistryKey<EquipmentAsset> CAST_STEEL_KEY = RegistryKey.of(REGISTRY_KEY, Identifier.of(PizzasOAT.MOD_ID, "cast_steel"));
